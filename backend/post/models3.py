...
class Cat(models.Model):
    ...
    organ = models.ForeignKey('Organ', models.DO_NOTHING, blank=True, null=True)
...
class Comment(models.Model):
    post = models.ForeignKey('Post', models.DO_NOTHING, db_column='Post_id', blank=True, null=True)  # Field name made lowercase.
...
class Medical(models.Model):
    ...
    vacc = models.CharField(max_length=45, blank=True, null=True)
...
class User(models.Model):
    login_id = models.CharField(db_column='Login_id', max_length=45, blank=True, null=True)  # Field name made lowercase.
    login_pw = models.CharField(db_column='Login_pw', max_length=45, blank=True, null=True)  # Field name made lowercase.
    organ = models.ForeignKey(Organ, models.DO_NOTHING, blank=True, null=True)
